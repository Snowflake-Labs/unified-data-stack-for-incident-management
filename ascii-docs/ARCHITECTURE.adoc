...
*Source:* link:../src/incident_management/models/bronze_zone/users.sql[`models/bronze_zone/users.sql`]
...
*Source:* link:../src/incident_management/models/bronze_zone/v_qualify_slack_messages.sql[`models/bronze_zone/v_qualify_slack_messages.sql`]
...
*Source:* link:../src/incident_management/models/gold_zone/incidents.sql[`models/gold_zone/incidents.sql`]
...
*Source:* link:../src/incident_management/models/gold_zone/incident_comment_history.sql[`models/gold_zone/incident_comment_history.sql`]
...
*Source:* link:../src/incident_management/models/gold_zone/incident_attachments.sql[`models/gold_zone/incident_attachments.sql`]
...
*Source:* link:../src/incident_management/models/gold_zone/active_incidents.sql[`models/gold_zone/active_incidents.sql`]
...
*Source:* link:../src/incident_management/models/gold_zone/closed_incidents.sql[`models/gold_zone/closed_incidents.sql`]
...
*Source:* link:../src/incident_management/models/gold_zone/weekly_incident_trends.sql[`models/gold_zone/weekly_incident_trends.sql`]
...
* Review link:DEMOS.adoc[Demo Vignettes] to see the system in action
* Check link:SETUP.adoc[Setup Guide] for installation instructions
