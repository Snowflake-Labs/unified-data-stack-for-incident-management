...
Refer to the link:../demos.adoc[Demo Vignettes] for how to use the Cortex Agent this project deploys in Snowflake Intelligence, and link:../ascii-docs/sample_questions.adoc[sample queries] that can be used to answer questions about the incident management process.
