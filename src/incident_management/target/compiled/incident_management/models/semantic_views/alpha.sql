...
TABLES(
  incidents as v1_incident_management.gold_zone.incidents
    COMMENT = 'Materialized incidents table with enriched data and calculated fields'

  , active_incidents as v1_incident_management.gold_zone.active_incidents
    COMMENT = 'Active incidents requiring attention with SLA status and priority ordering'

  , closed_incidents as v1_incident_management.gold_zone.closed_incidents
    COMMENT = 'Closed incidents with resolution metrics and performance insights'

  , incident_attachments as v1_incident_management.gold_zone.incident_attachments
    COMMENT = 'Materialized incident attachments table'

  , incident_comment_history as v1_incident_management.gold_zone.incident_comment_history
    COMMENT = 'Simplified incident comment history for tracking communication'

  , weekly_incident_trends as v1_incident_management.gold_zone.weekly_incident_trends
    COMMENT = 'Weekly incident trends for the last 12 weeks'

  , quaterly_review_metrics as v1_incident_management.gold_zone.quaterly_review_metrics
