...
[IMPORTANT]
*To demonstrate the design pattern of this stack the project uses incident management as an illustrative subset of the real-world business process only to show the art of possible with this modern design pattern on Snowflake that can be applied for any industry or business process.*

=== Key Features

==== 1. *Open new data frontiers* to ingest from using OpenFlow connectors
==== 2. *Standardize data models* using SQL and well established engineerings tools like dbt core 
==== 3. *Interleave AISQL* within dbt models for dynamic reasoning and decision making
    3.1 This includes using AISQL to process unstructured text and images for classification and enrichment

    3.2 Or, unstructured documents (PDFss, PPTs, TXTs, etc) for search and retrieval, and question extraction

==== 4. *Deploy Cortex services* such as Cortex Search and Cortex Agents from within the same dbt Project
==== 5. *Unlock conversational AI* through Snowflake Intelligence for decision making through all data within a business process.
