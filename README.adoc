...
*Author*: link:https://github.com/chinmayee-lakkad[Chinmayee Lakkad]
...
==== 2. *Standardize data models* using SQL and well-established engineering tools like dbt core 
==== 3. *Interleave AISQL* within dbt models for dynamic reasoning and decision-making
    ...
    3.2 Or, unstructured documents (PDFs, PPTs, TXTs, etc.) for search and retrieval, and question extraction
